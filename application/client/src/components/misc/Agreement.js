	...
	return (
		<div className='gradient-hor bg-pan-right flex-center-1'>
			<div className='content'>
				...
				<small>Last updated July 17, 2022</small>
				<ol>
					<li>
						{' '}
						...
						<p>
							...
							behalf of an entity (“you”) and GATORSHARE
							("Company," “we," “us," or “our”), concerning your
							access to and use of the http://www.gatorshare.com
						...
						<p>
							...
							laws, you may not use this Site. You may not use the
							Site in a way that would violate the
					...
					<li>
						...
						<p>
							...
							is hosted in the United States. If you access the
							...
							your continued use of the Site, you are transferring
							your data to the United States, and you agree to
					...
					<li>
						...
						<p>
							...
							law; and (6) a statement that the information in the
					...
					<li>
						...
						<p>
							...
							been removed from the Site as a result of a mistake
							or misidentification, you may submit a written
							counter notification to our Designated Copyright
							Agent using the contact information provided below
							(a “Counter Notification”). To be an effective
							Counter Notification under the DMCA, your Counter
							Notification must include substantially the
							following: (1) identification of the material that
							has been removed or disabled and the location at
							which the material appeared before it was removed or
							disabled; (2) a statement that you consent to the
							jurisdiction of the Federal District   Court in which
							your address is located, or if your address is
							outside the United States, for any judicial district
							in which we are located; (3) a statement that you
							will accept service of process from the party that
							filed the Notification or the party's agent; (4)
							your name, address, and telephone number; (5) a
							...
							disabled; and (6) your physical or electronic
							signature.{' '}
						</p>
						<p>
							...
							Notification informing us that such party has filed
							a court action to restrain you from engaging in
							infringing activity related to the material in
							question. Please note that if you materially
							misrepresent that the disabled or removed content
							was removed by mistake or misidentification, you may
							be liable for damages, including costs and
					...
					<li>
						...
						<p>
							...
							Agreement to the jurisdiction of the federal courts.
							GATORSHARE shall also maintain the right to bring
							proceedings as to the substance of the matter in the
							courts of the country where you reside or, if these
							Terms are entered into in the course of your trade
							or profession, the state of your principal place of
							business.{' '}
						</p>
					</li>
					...
					<li>
						...
						<br />
						<p>GATORSHARE.</p>
						<p>mtoure@mail.sfsu.edu</p>
						<p>Phone: (+1)318-497--2270</p>
					</li>
				</ol>
			</div>
		</div>
