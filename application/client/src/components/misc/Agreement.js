					...
					<ol>
						<li>
							...
							<p>
								...
								or on behalf of an entity (“you”) and GATORSHARE
								("Company," “we," “us," or “our”), concerning
								your access to and use of the
								http://www.gatorshare.com website as well as any
						...
						<li>
							...
							<p>
								...
								with these Terms of Use; (4) you are not a minor
								in the jurisdiction in which you reside; (5) you
								will not access the Site through automated or
								non-human means, whether through a bot, script,
								or otherwise; (6) you will not use the Site for
								any illegal or unauthorized purpose; and (7)
						...
						<li>
							...
							<p>
								...
								you with opportunity to create, submit, post,
						...
						<li>
							...
							<p>
								...
								use of the Site, you are transferring your data
								to the United States, and you agree to have your
								data transferred to and processed in the United
								States.{' '}
							</p>
						</li>
						<li>
							...
							<p>
								...
								first contacting an attorney. All Notifications
								...
								infringed; (2) identification of the copyrighted
								work claimed to have been infringed, or, if
								multiple copyrighted works on the Site are
								covered by the Notification, a representative
								list of such works on the Site; (3)
						...
						<li>
							...
							<p>
								...
								been removed from the Site as a result of a
								mistake or misidentification, you may submit a
								written counter notification to our Designated
								Copyright Agent using the contact information
								provided below (a “Counter Notification”). To be
								an effective Counter Notification under the
								DMCA, your Counter Notification must include
								substantially the following: (1) identification
								of the material that has been removed or
								disabled and the location at which the material
								appeared before it was removed or disabled; (2)
								a statement that you consent to the jurisdiction
								of the Federal District   Court in which your
								address is located, or if your address is
								outside the United States, for any judicial
								district in which we are located; (3) a
								statement that you will accept service of
								process from the party that filed the
						...
						<li>
							...
							<p>
								...
								within the State of California, without regard
						...
						<li>
							...
							<p>
								...
								related to Terms or the relationship established
								by this Agreement to the jurisdiction of the
								federal courts. GATORSHARE shall also maintain
								the right to bring proceedings as to the
								substance of the matter in the courts of the
								country where you reside or, if these Terms are
								entered into in the course of your trade or
								profession, the state of your principal place of
								business.{' '}
							</p>
						</li>
						...
						<li>
							...
							<p>
								...
								of the Site; (3) breach of these Terms of Use;
								...
								toward any other user of the Site with whom you
